			...
			<ul class="collapsible popout" data-collapsible="accordion">
				...
				<div id="updateCompanyModal{{$value->company_id}}" class="modal updateCompanyModal modal-fixed-footer">
					...
					<div class="modal-footer">
						...
						<button id="update_company_button" onclick="submitUpdateCompany({{$value->company_id}});" class="modal-action btn waves-effect submit_button" ><b>Editar</b></button>
					</div>
				</div>
...
<div id="newCompanyModal" class="modal newCompanyModal modal-fixed-footer">
	...
	<div class="modal-footer">
		<a href="#!" class="modal-action modal-close waves-effect btn-flat"><b>Cancelar</b></a>
		<button id="add_company_button" onclick="submitNewCompany();" class="modal-action btn waves-effect submit_button" disabled><b>Registrar</b></button>
	</div>
</div>
@endsection